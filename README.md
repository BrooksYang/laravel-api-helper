...
## 更新日志
>v1.5.1 2019-03-01 文件结构调整

>v1.5.0 2019-02-28 测试工具优化 - 提供 Pretty、Raw、Preview 三种响应结果视图

>v1.4.7 2019-02-28 压力测试调整为可选功能，默认关闭

>v1.4.6 2019-02-28 压缩css文件

>v1.4.5 2019-02-28 测试工具优化
>- 返回完整异常信息
>- 允许使用 dd、dump、echo 等方法直接打印数据

>v1.4.4 2018-07-20 左侧菜单样式优化

>v1.4.3 2018-06-28 模块分组优化

>v1.4.2 2018-06-28 新增模块分组功能，以区分不同命名空间下的重名文件夹

>v1.4.1 2018-06-24 修复api-helper配置文件的bug

>v1.4.0 2018-06-24 可指定文档生成的命名空间，向下兼容v1.3，默认命名空间为App\Http\Controllers

>v1.3.2 2018-03-31 压力测试安全机制优化

>v1.3.0 2018-02-13 表单支持文件上传

>v1.2.0 2018-01-22 新增ResponseHelper Trait，封装常用api返回方法

>v1.1.1 2018-01-22 Guzzle 请求异常处理

>v1.1.0 2017-12-18 支持在线ApacheBench服务器压力测试，并缓存最近一次压测结果，在接口列表及详情页展示
